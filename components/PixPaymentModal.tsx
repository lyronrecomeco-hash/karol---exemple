          ...
          {step === 'qr' ? (
            <>
              <div className="flex justify-between items-center">
                <div className="space-y-1">
                  <h3 className="text-xl font-black text-white italic uppercase tracking-tighter">Pagamento PIX</h3>
              ...
              <div className="bg-white/5 p-4 rounded-2xl space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Expira em:</span>
              ...
              <div className="flex flex-col items-center space-y-6 py-2">
                ...
                <div className="text-center space-y-1">
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Valor do pedido:</p>
              ...
              <div className="bg-cyan-500/5 border border-cyan-500/10 rounded-2xl p-4 space-y-3">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2 text-[10px] text-gray-400 font-medium">
                    ...
                    <span>Copie o código ou escaneie o QR Code acima.</span>
                  </li>
                  <li className="flex items-start space-x-2 text-[10px] text-gray-400 font-medium">
                    <span className="text-cyan-400">•</span>
                    <span>No seu banco, selecione a opção <b>"Pix Copia e Cola"</b>.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                <button 
                  onClick={() => {
                    navigator.clipboard.writeText("00020101021226870014br.gov.bcb.pix2565demo-pix-code-0123456789");
            ...
            <div className="py-20 flex flex-col items-center space-y-8">
              ...
              <div className="text-center space-y-2">
                <p className="text-xl font-black text-white italic tracking-tighter uppercase">Validando...</p>
                <p className="text-gray-500 text-xs font-bold uppercase tracking-widest">Identificando transação demo</p>
              </div>
            </div>
          )}
        </div>
